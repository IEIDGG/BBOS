    ...
    def process_bestbuy_orders(self, folder: str) -> None:
        try:
            ...
            if not orders:
                ...
                existing_orders = self.output_handler.db_manager.get_all_orders()
                if existing_orders:
                    print(f"Found {len(existing_orders)} existing orders in database to check for updates")
                    orders = existing_orders
                else:
                    print("No existing orders in database")
